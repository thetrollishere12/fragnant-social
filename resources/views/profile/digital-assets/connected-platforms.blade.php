    ...
    <div class="md:flex">
        ...
        <div>
           <div class="md:col-span-1 flex justify-between">
              <div class="p-1">
                 <h3 class="text-lg font-medium text-gray-900">Connected Platform List</h3>
                 <p class="mt-1 text-sm text-gray-600">
                    List of your connected platform accounts
                 </p>
              </div>
              <div class="p-1">
              </div>
           ...
           <x-custom.digital-asset-layout :digitalAssetId="$digital_asset_id">
               ...
               @livewire('profile.digital-assets.connected-platform',[
